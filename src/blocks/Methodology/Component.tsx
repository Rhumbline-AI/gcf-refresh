...
export const MethodologyBlock: React.FC<MethodologyProps> = ({ title, subtitle, definition, items }) => {
  // Text to repeat around the circle - capitalize each word
  ...
  const repetitions = 40 // Number of times to repeat the text around the circle - increased to ensure continuous coverage
  ...
  return (
    ...
    >
      <div className="container relative z-10 flex flex-col items-center justify-center">
        {/* The Blue Circle */}
        <div className="relative w-full max-w-[990px] aspect-square">
          {/* Repeating text around the circle */}
          <svg 
